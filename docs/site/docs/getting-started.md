...
sidebar_position: 1
description: First-time setup guide for Kairos.
---
...
- [Configuration](user-guide/configuration.md) — Customize Kairos
- [Providers](user-guide/providers.md) — Set up different LLM providers
- [Tools](user-guide/tools.md) — Learn about available tools
