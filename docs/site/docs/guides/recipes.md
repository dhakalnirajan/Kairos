...
title: Recipes
sidebar_position: 1
description: Common workflows and recipes for using Kairos.
---
...
- [Tools](../user-guide/tools.md) — All available tools
- [Slash Commands](../user-guide/slash-commands.md) — All commands