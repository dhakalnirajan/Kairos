...
Kairos provides 68 built-in tools organized by category.
...
Every tool call passes through the 6-layer safety pipeline:
...
- [Tools API](api-reference.md) — Programmatic tool usage
